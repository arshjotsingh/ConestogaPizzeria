...
$result1 = mysqli_query($mysqli,"INSERT INTO PersonalInfo (UserId, DateCreated, FirstName, Lastname, Address, City, ProvinceId, PostalCode, Telephone, EmailId) VALUES ('$uid', '$a', '$fname', '$lname', '$address', '$city', '$provid', '$postalcode', '$telephone', '$email')");
